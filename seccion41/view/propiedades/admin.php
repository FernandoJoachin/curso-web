<main class="contenedor seccion">
        ...
        <a href="/public/propiedades/crear" class="boton boton-amarillo">Ir a Crear Propiedad</a>
        <a href="/public/vendedores/crear" class="boton boton-amarillo">Ir a Crear Vendedor(a)</a>
        ...
        <table class="propiedades">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="boton-amarillo-block" href="/public/propiedades/actualizar?id=<?php echo $propiedad->id; ?>">Actualizar</a>
                        <form class="w-100" method="POST" action="/public/propiedades/eliminar">
