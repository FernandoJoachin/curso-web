<h2 class="pagin__heading"><?php echo $titulo;?></h2>
<p class="pagin__descripcion">Elije hasta 5 eventos para asistir de forma presencial</p>

<div class="eventos-registro">
    <main class="eventos-registro__listado">
        <h3 class="eventos-registro__heading--conferencias">&lt;Conferencias/></h3>
        <p class="eventos-registro__fecha">Viernes 23 de Junio</p>
        ...
        <p class="eventos-registro__fecha">Sábado 24 de Junio</p>
