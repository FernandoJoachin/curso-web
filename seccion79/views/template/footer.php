<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            <a href="/"><h3 class="barra__logo">&#60;DevWebCamp/></h3></a>
            <p class="footer__texto">
                DevWebCamp es una conferencia para desarrolladores de todos los niveles, se lleva
                a cabo de forma presencial y en linea
            </p>
        </div>
        <!-- Codigo menu-redes proporcionado-->
    ...
    <p class="footer__copyright">
        ...
        <span class="footer__copyright--regular">
            - Todos los derechos reservador &copy; <?php echo date("Y"); ?>
        </span>
    </p>
</footer>