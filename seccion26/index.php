        ...
        <div class="contenedor-anuncios">
            <div class="anuncio">
                <picture>
                    ...
                    <img loading="lazy" width="200" height="300" src="build/img/anuncio1.jpg" alt="Casa del lago">
                </picture>
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <img loading="lazy" width="200" height="300" src="build/img/anuncio2.jpg" alt="Casa terminados">
                </picture>
                <div class="contenido-anuncio">
                    <h3>Casa terminados de lujo</h3>
                    <p>Casa terminados con excelente vista, acabados de lujo a un excelente precio</p>
                    <p class="precio">$3,0000,000</p>
                    <ul class="iconos-caracteristicas">
                        <li>
                            <img class="icono" loading="lazy" src="build/img/icono_wc.svg" alt="icono wc">
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <img loading="lazy" width="200" height="300" src="build/img/anuncio3.jpg" alt="Casa alberca">
                </picture>
                <div class="contenido-anuncio">
                    <h3>Casa con alberca</h3>
                    <p>Casa en alberca con excelente vista, acabados de lujo a un excelente precio</p>
                    <p class="precio">$3,0000,000</p>
                    <ul class="iconos-caracteristicas">
                        <li>
                            <img class="icono" loading="lazy" src="build/img/icono_wc.svg" alt="icono wc">
